...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("query", type=str, help="Raw user query to rerank retrieved candidates.")
    parser.add_argument(
        "--manifest-path",
        type=Path,
        default=None,
...
def main() -> None:
    ...
    result = rerank_candidates(args.query, settings=settings, retrieval=retrieval)
